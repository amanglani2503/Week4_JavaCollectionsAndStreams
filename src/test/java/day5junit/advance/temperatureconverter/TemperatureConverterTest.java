package day5junit.advance.temperatureconverter;
...
class TemperatureConverterTest {
    ...
    void testCelsiusToFahrenheit() {
        ...
        assertEquals(77.0, TemperatureConverter.celsiusToFahrenheit(25), 0.001);
    }
    ...
    void testFahrenheitToCelsius() {
        ...
        assertEquals(25.0, TemperatureConverter.fahrenheitToCelsius(77), 0.001);
    }
}
